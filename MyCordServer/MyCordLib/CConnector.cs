...
namespace MyCordLib
{
    ...
    public class CConnector
    {
        ...
        public delegate void ReconnectionHandler();
        public ReconnectionHandler reconnection_callback { get; set; }
        ...
        private void on_connect_completed(object sender, SocketAsyncEventArgs e)
        {
            if (e.SocketError == SocketError.Success)
            {
                ...
                // 데이터 수신 준비.
                this.network_service.on_new_server_connected(this.client, token);
