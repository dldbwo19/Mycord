...
namespace Mycord_WPF
{
    ...
    {
        public static readonly DependencyProperty AlwaysScrollToEndProperty = DependencyProperty.RegisterAttached("AlwaysScrollToEnd", typeof(bool), typeof(AutoScrollProperty), new PropertyMetadata(false, AlwaysScrollToEndChanged));
